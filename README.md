...
# Whether a text with the emoji name will appear when you put your mouse cursor over emoji in the chat.
# This feature MAY NOT WORK if you use chat formatters like "VaultChatFormatter"
emojiHoverEnabled: true
emojiHoverColor: "#AAAAAA" # The color of the text in hover

# Chat suggestions modes (when typing a message in chat and hitting TAB on keyboard):
# NONE - No suggestions
